...
import webProject.auth.AuthenticationFailedException;
import webProject.auth.JWTTokenAuthFilter;
import webProject.framework.api.APIResponse;
import webProject.framework.controller.BaseController;
import webProject.model.dto.UserDTO;
...
public class UserController extends BaseController {
     ...
     * POST Formato che si aspetta - {"user":{"displayName":"Display Name", "email":"qualcosa@qualcosa.com"}}
     *
     * @param userDTO
     * @return
     */
    ...
    /**
     * Logout di un utente eliminando la sessione
     *
     * @param userDTO
     * @return
     */
