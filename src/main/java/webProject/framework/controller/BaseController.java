package webProject.framework.controller;
...
/**
 * Tutti i controlli in spring devono estendere questo controller
 * per centralizzare ogni sorta di funzionalità comune, per 
 * esempio l'estrazione dei dati dal corpo di una POST
 * 
 */
